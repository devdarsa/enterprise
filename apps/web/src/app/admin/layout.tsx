  ...
  const instansiConfig = {
    pondok: {
      ...
      menus: [
        ...
        { label: 'Portal Guru Ustadz', path: '/guru/dashboard', icon: '📖' },
        { label: 'Portal Wali Santri', path: '/wali/dashboard', icon: '👨‍👩‍👧' },
        { label: 'Super Admin SaaS', path: '/super-admin/dashboard', icon: '🚀' },
      ],
    },
    madrasah: {
    ...
    mi: {
      ...
      menus: [
        ...
        { label: 'Portal Santri Mandiri', path: '/santri/dashboard', icon: '🎒' },
        { label: 'Portal Wali Santri', path: '/wali/dashboard', icon: '👨‍👩‍👧' },
      ],
    },
  };
